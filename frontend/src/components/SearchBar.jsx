...
const SearchBar = () => {
  ...
  return showSearch && visible ? (
    <div className=' text-center transition-all duration-300 ease-in-out mb-2'>
      <div className='inline-flex items-center justify-center border border-gray-400 px-5 my-5 mx-3 rounded-full w-3/4 sm:w-1/2'>
       <input value={search} onChange={(e) =>setSearch(e.target.value)} className='flex-1 outline-none bg-inherit text-gray-900' type="text" placeholder='Search' /> 
